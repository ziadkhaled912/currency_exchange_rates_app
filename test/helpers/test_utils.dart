...
final currencyRepository = MockCurrencyRepository();
...
Future<void> initSignedInUser({
  ...
  locator
    ..unregister<CurrencyRepository>()
    ..registerLazySingleton<CurrencyRepository>(() => currencyRepository)
    ..unregister<CurrencyCubit>()
    ..registerFactory<CurrencyCubit>(
